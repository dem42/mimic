...
pub fn get_window_surface_from_winit(
    winit_window: &winit::window::Window,
) -> Result<WindowSurface> {
    #[cfg(all(unix, not(target_os = "android"), not(target_os = "macos")))]
    let surface = {
        use winit::platform::unix::WindowExtUnix;
        let xlib_window = winit_window
            .xlib_window()
            .ok_or(VulkanError::WindowCreateFailure);
        let xlib_display = winit_window
            .xlib_display()
            .ok_or(VulkanError::WindowCreateFailure);
    ...
    let surface = {
        ...
        WindowSurface::MacOsSurface { ns_window, ns_view }
    };
    ...
    let surface = {
        ...
        WindowSurface::WindowsSurface { hinstance, hwnd }
    };
